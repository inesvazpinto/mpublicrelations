...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_swiper__ = __webpack_require__(4);
...
$('.option-item').click(function () {
    ...
    $('.options-box').toggleClass('open');
    $('.btn-services').toggleClass('btn--hidden');

    $('.section-titles').toggleClass('t-visible');
